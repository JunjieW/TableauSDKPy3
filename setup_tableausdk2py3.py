...
setup(
    ...
    version='0.1.0',
    packages=['tableausdk2py3'],
    package_data={'tableausdk2py3' : copy_list},
    description="Tableau HyperExtract SDK package (Python 3)",
    license='LICENSE.txt', # TODO: udpate license
    author='Tableau Software', # RiskDev@BAM
    author_email='support@tableau.com', # RiskDev@BAM
